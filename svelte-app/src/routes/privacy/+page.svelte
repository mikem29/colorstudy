...
<svelte:head>
  <title>Privacy Policy - HueMixy</title>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-8">
      ...
      <div class="prose max-w-none space-y-6 text-gray-700">
        <section>
          ...
          <p>
            We collect information you provide directly to us when you create an account, including your email address and password. When you use HueMixy, we collect information about your artboards, color swatches, and images you upload.
          </p>
        </section>
        ...
        <section>
          <h3 class="text-xl font-semibold text-gray-900 mb-3">Information Sharing</h3>
          <p>
        ...
        <section>
          <h3 class="text-xl font-semibold text-gray-900 mb-3">Data Security</h3>
          <p>
        ...
        <section>
          ...
          <p>
            You may update, correct, or delete your account information at any time by logging into your account. You may also contact us at <a href="mailto:support@huemixy.com" class="text-blue-600 hover:text-blue-700">support@huemixy.com</a> to request access to, correction of, or deletion of your personal information.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            We use cookies and similar technologies to provide and support our services and to collect information about your interactions with our service.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            If you have any questions about this Privacy Policy, please contact us at <a href="mailto:support@huemixy.com" class="text-blue-600 hover:text-blue-700">support@huemixy.com</a>.
          </p>
        </section>
      </div>
    </div>
